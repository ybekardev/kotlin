...
fun main() {
    ...
    org.kotlin.iteratorOne()

    org.kotlin.label()
    org.kotlin.labelLambda()
    org.kotlin.labelForEach()
    org.kotlin.labelLoop()

    org.kotlin.forLoop()
    org.kotlin.whileLoop()
    println(org.kotlin.describe(1))
    println(org.kotlin.describe("Hi"))
    println(org.kotlin.describe(12L))
    println(org.kotlin.describe(1.32))
    println(org.kotlin.describeString("Hi"))
    org.kotlin.withIndexLoop()
